...
model_6.add(Dense(1, activation="sigmoid", kernel_initializer="uniform"))
...
model_6.fit(x=X_train, y=y_train, batch_size=32, epochs=100, verbose=1)

# %%
# evaluating on unknown data
score = model_6.evaluate(x=X_test, y=y_test)
